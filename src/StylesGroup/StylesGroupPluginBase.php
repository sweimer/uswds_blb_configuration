...
use Drupal\uswds_blb_configuration\HelperTrait;
...
abstract class StylesGroupPluginBase extends PluginBase implements StylesGroupPluginInterface, ContainerFactoryPluginInterface {
   ...
   * @var string
   */
  const CONFIG = 'uswds_blb_configuration.style_settings';
  ...
  public function getIconPath() {
    // The default icon.
    $icon_path = \Drupal::service('extension.list.module')->getPath('uswds_blb_configuration') . '/images/plugins/plugin-group-default-icon.svg';
