...
class StylesGroupManager extends DefaultPluginManager {
   ...
   *
   * @var \Drupal\uswds_blb_configuration\Style\StylePluginManagerInterface
   */
   ...
   * @param \Drupal\uswds_blb_configuration\Style\StylePluginManagerInterface $style_manager
   *   The style plugin manager interface.
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler, StylePluginManagerInterface $style_manager, ConfigFactoryInterface $config_factory) {
    parent::__construct(
      ...
      $namespaces,
      $module_handler,
      'Drupal\uswds_blb_configuration\StylesGroup\StylesGroupPluginInterface',
      'Drupal\uswds_blb_configuration\Annotation\StylesGroup'
    );
    $this->alterInfo('uswds_blb_configuration_info');
    $this->setCacheBackend($cache_backend, 'uswds_styles_group');
