...
class Border extends StylePluginBase {
  ...
  public function buildStyleFormElements(array &$form, FormStateInterface $form_state, $storage) {
    ...
    $form['border_type'] = [
      '#type' => 'radios',
      '#options' => [
        'border' => $this->t('Border') . '<div class="uswds_tooltip" data-placement="top" role="tooltip">' . $this->t('All') . '</div>',
        'border_left' => $this->t('Left') . '<div class="uswds_tooltip" data-placement="top" role="tooltip">' . $this->t('Left') . '</div>',
        'border_top' => $this->t('Top') . '<div class="uswds_tooltip" data-placement="top" role="tooltip">' . $this->t('Top') . '</div>',
        'border_right' => $this->t('Right') . '<div class="uswds_tooltip" data-placement="top" role="tooltip">' . $this->t('Right') . '</div>',
        'border_bottom' => $this->t('Bottom') . '<div class="uswds_tooltip" data-placement="top" role="tooltip">' . $this->t('Bottom') . '</div>',
      ],
    ...
    $form['rounded_corners'] = [
      '#type' => 'range',
      '#title' => '<span class="sr-only">' . $this->t('Corners') . '</span><div class="uswds_tooltip" data-placement="top" role="tooltip">' . $this->t('All Corners') . '</div>',
      '#min' => 0,
    ...
    foreach ($corners as $corner_key => $corner_value) {
      ...
      $form['rounded_corner_' . $corner_key] = [
        '#type' => 'range',
        '#title' => '<span class="sr-only">' . $this->t('@corner', ['@corner' => $corner_value]) . '</span><div class="uswds_tooltip" data-placement="top" role="tooltip">' . $this->t('@corner', ['@corner' => $corner_value]) . '</div>',
        '#min' => 0,
    ...
    $form['#attached']['drupalSettings']['uswds_blb_configuration']['border'] = $border_options;

    // Attach the Layout Builder form style for this plugin.
    $form['#attached']['library'][] = 'uswds_blb_configuration/plugin.border.layout_builder_form';
