...
class TextAlignment extends StylePluginBase {
  ...
  public function buildStyleFormElements(array &$form, FormStateInterface $form_state, $storage) {
    ...
    $form['text_alignment'] = [
      ...
      '#validated' => TRUE,
      '#attributes' => [
        'class' => ['field-text-alignment', 'uswds_input-boxes-boxes'],
      ],
    ];
    ...
    $form['#attached']['library'][] = 'uswds_blb_configuration/plugin.text_alignment.layout_builder_form';
