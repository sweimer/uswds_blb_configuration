...
class BreakpointForm extends EntityForm implements ContainerInjectionInterface {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\uswds_blb_configuration\BreakpointInterface $breakpoint */
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\uswds_blb_configuration\Entity\Breakpoint::load',
      ],
